...
# Configuração inicial da página da aplicação (DEVE SER O PRIMEIRO COMANDO STREAMLIT)
...
def main():
    ...
    if (data_file_1 is not None):
        ...
        dict_acoes = {
            ...
            'DDD': 'Churn! clientes que gastaram bem pouco...',
            'DAA': 'Churn! clientes que gastaram bastante...',
            'CAA': 'Churn! clientes que gastaram bastante...'
        }
